...
<div className="bg-gray-400 min-h-screen pt-80 ">


<div class=" dark:bg-gray-800 h-screen  py-6 sm:py-8 lg:py-6">
    <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
        <div class="mb-4 flex items-center justify-between gap-8 sm:mb-8 md:mb-12">
            <div class="flex items-center gap-12">
                <h2 class="text-2xl font-bold text-gray-800 lg:text-3xl dark:text-white">Competences</h2>
